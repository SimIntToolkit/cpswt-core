...
RUN apt-get update && apt-get install -y \
    apt-transport-https bison build-essential ca-certificates clang curl \
    doxygen flex gcc gdb git gradle graphviz libboost1.71-all-dev \
    libcppunit-dev libjsoncpp-dev libosgearth-dev libqt5opengl5-dev \
    libwebkit2gtk-4.0-37 libxml2-dev lld make mongodb mpi-default-dev \
    openjdk-8-jdk openscenegraph-plugin-osgearth perl python2 python3 \
    python3-pip python-is-python2 qt5-qmake qtbase5-dev \
    qtbase5-dev-tools qtchooser software-properties-common wget xterm zlib1g-dev

# Install Python packages
RUN python3 -m pip install --system --upgrade jinja2 matplotlib numpy \
    pandas posix_ipc scipy seaborn webgme-bindings
