...
public class C2WInteractionRoot extends org.cpswt.hla.InteractionRoot {
    ...
    */
    ...
    /**
     * Returns the fully-qualified (dot-delimited) federation name of the InteractionRoot.C2WInteractionRoot interaction class.
     * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot', 'property_name': 'actualLogicalGenerationTime'}");
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot', 'property_name': 'federateFilter'}");
                _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
                _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot', 'property_name': 'originFed'}");
                _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
                _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot', 'property_name': 'sourceFed'}");
                _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
                _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
