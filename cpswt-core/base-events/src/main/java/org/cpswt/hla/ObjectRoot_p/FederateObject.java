...
/**
 * Implements ObjectRoot_p.FederateObject
 */
...
/**
 * Returns the fully-qualified (dot-delimited) name of the ObjectRoot_p.FederateObject object class.
...
public static String get_class_name() {
    return "ObjectRoot_p.FederateObject";
}
 ...
 * class name) of the ObjectRoot_p.FederateObject object class.
 *
 ...
 * ObjectRoot_p.FederateObject object class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
...
static {
    ...
    _classNameClassMap.put(get_class_name(), FederateObject.class);
    ...
    key = new ClassAndPropertyName(get_class_name(), "FederateHandle");
    _classAndPropertyNameTypeMap.put(key, "int");

    key = new ClassAndPropertyName(get_class_name(), "FederateHost");
    _classAndPropertyNameTypeMap.put(key, "String");

    key = new ClassAndPropertyName(get_class_name(), "FederateType");
    _classAndPropertyNameTypeMap.put(key, "String");
    ...
    _classNamePublishedAttributeNameSetMap.put(get_class_name(), _publishedAttributeNameSet);
    _classNameSubscribedAttributeNameSetMap.put(get_class_name(), _subscribedAttributeNameSet);
}
...
/**
 * Returns the handle (RTI assigned) of the ObjectRoot_p.FederateObject object class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
 ...
 * this object class (i.e. "ObjectRoot_p.FederateObject") given the attribute's name.
 *
...
public static int get_attribute_handle(String propertyName) {
    return get_attribute_handle_aux(get_class_name(), propertyName);
}
...
static {
    ...
    _classNamePublishedAttributeHandleSetMap.put(get_class_name(), _publishedAttributeHandleSet);

    _subscribedAttributeHandleSet = _factory.createAttributeHandleSet();
    _classNameSubscribedAttributeHandleSetMap.put(get_class_name(), _subscribedAttributeHandleSet);
}
...
protected static void init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            _handle = rti.getObjectClassHandle(get_class_name());
    ...
    while(isNotInitialized) {
        try {
            ...
            propertyHandle = rti.getAttributeHandle("{'class_name': 'ObjectRoot_p.FederateObject', 'property_name': 'FederateHandle'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'ObjectRoot_p.FederateObject', 'property_name': 'FederateHandle'}");
            ...
            propertyHandle = rti.getAttributeHandle("{'class_name': 'ObjectRoot_p.FederateObject', 'property_name': 'FederateHost'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'ObjectRoot_p.FederateObject', 'property_name': 'FederateHost'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getAttributeHandle("{'class_name': 'ObjectRoot_p.FederateObject', 'property_name': 'FederateType'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'ObjectRoot_p.FederateObject', 'property_name': 'FederateType'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
...
/**
 * Publishes the ObjectRoot_p.FederateObject object class for a federate.
 *
...
public static void publish_object(RTIambassador rti) {
    ...
    for(ClassAndPropertyName key : _publishedAttributeNameSet) {
        try {
            ...
            logger.trace("publish {}:{}", get_class_name(), key.toString());
        } catch (Exception e) {
...
/**
 * Unpublishes the ObjectRoot_p.FederateObject object class for a federate.
 *
...
/**
 * Subscribes a federate to the ObjectRoot_p.FederateObject object class.
 *
 * @param rti handle to the Local RTI Component
 */
public static void subscribe_object(RTIambassador rti) {
    ...
    for(ClassAndPropertyName key : _subscribedAttributeNameSet) {
        try {
            ...
            logger.trace("subscribe {}:{}", get_class_name(), key.toString());
        } catch (Exception e) {
...
/**
 * Unsubscribes a federate from the ObjectRoot_p.FederateObject object class.
 *
 * @param rti handle to the Local RTI Component
 */
 ...
 * (that is, the ObjectRoot_p.FederateObject object class).
 *
 * @param handle handle to compare to the value of the handle (RTI assigned) of
 * this class (the ObjectRoot_p.FederateObject object class).
...
public void set_FederateHandle(Integer value) {
    ClassAndPropertyName key = new ClassAndPropertyName(get_class_name(), "FederateHandle");
...
public double get_FederateHandle_time() {
    return ((Attribute<Object>)classAndPropertyNameValueMap.get(
      new ClassAndPropertyName(get_class_name(), "FederateHandle")
    )).getTime();
}
...
public void set_FederateHost(String value) {
    ClassAndPropertyName key = new ClassAndPropertyName(get_class_name(), "FederateHost");
    Attribute<Object> attribute = (Attribute<Object>)classAndPropertyNameValueMap.get(key);
    attribute.setValue(value);
    attribute.setTime(getTime());
}
...
public double get_FederateHost_time() {
    return ((Attribute<Object>)classAndPropertyNameValueMap.get(
      new ClassAndPropertyName(get_class_name(), "FederateHost")
    )).getTime();
}
...
public void set_FederateType(String value) {
    ClassAndPropertyName key = new ClassAndPropertyName(get_class_name(), "FederateType");
    Attribute<Object> attribute = (Attribute<Object>)classAndPropertyNameValueMap.get(key);
    attribute.setValue(value);
    attribute.setTime(getTime());
}
...
public double get_FederateType_time() {
    return ((Attribute<Object>)classAndPropertyNameValueMap.get(
      new ClassAndPropertyName(get_class_name(), "FederateType")
    )).getTime();
}
...
//------------------------------------
    ...
    */
    public static void publish_FederateHandle() {
        _publishedAttributeNameSet.add(new ClassAndPropertyName(get_class_name(), "FederateHandle"));
    }
    ...
    */
    public static void unpublish_FederateHandle() {
        _publishedAttributeNameSet.remove(new ClassAndPropertyName(get_class_name(), "FederateHandle"));
    }
    ...
    */
    public static void subscribe_FederateHandle() {
        _subscribedAttributeNameSet.add(new ClassAndPropertyName(get_class_name(), "FederateHandle"));
    }
    ...
    */
    public static void unsubscribe_FederateHandle() {
        _subscribedAttributeNameSet.remove(new ClassAndPropertyName(get_class_name(), "FederateHandle"));
    }
    ...
    */
    public static void publish_FederateHost() {
        _publishedAttributeNameSet.add(new ClassAndPropertyName(get_class_name(), "FederateHost"));
    }
    ...
    */
    public static void unpublish_FederateHost() {
        _publishedAttributeNameSet.remove(new ClassAndPropertyName(get_class_name(), "FederateHost"));
    }
    ...
    */
    public static void subscribe_FederateHost() {
        _subscribedAttributeNameSet.add(new ClassAndPropertyName(get_class_name(), "FederateHost"));
    }
    ...
    */
    public static void unsubscribe_FederateHost() {
        _subscribedAttributeNameSet.remove(new ClassAndPropertyName(get_class_name(), "FederateHost"));
    }
    ...
    */
    public static void publish_FederateType() {
        _publishedAttributeNameSet.add(new ClassAndPropertyName(get_class_name(), "FederateType"));
    }
    ...
    */
    public static void unpublish_FederateType() {
        _publishedAttributeNameSet.remove(new ClassAndPropertyName(get_class_name(), "FederateType"));
    }
    ...
    */
    public static void subscribe_FederateType() {
        _subscribedAttributeNameSet.add(new ClassAndPropertyName(get_class_name(), "FederateType"));
    }
    ...
    */
    public static void unsubscribe_FederateType() {
        _subscribedAttributeNameSet.remove(new ClassAndPropertyName(get_class_name(), "FederateType"));
    }
    ...
    */
    public FederateObject(FederateObject messaging_var) {
        ...
        for(ClassAndPropertyName key: classAndPropertyNameValueMap.keySet()) {
            classAndPropertyNameValueMap.put(key, new Attribute<Object>(classAndPropertyNameValueMap.get(key)));
        }
