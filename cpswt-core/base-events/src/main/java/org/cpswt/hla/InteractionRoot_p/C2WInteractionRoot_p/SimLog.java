...
public class SimLog extends org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot {
    ...
    */
    ...
    /**
     * Returns the fully-qualified (dot-delimited) federation name of the InteractionRoot.C2WInteractionRoot.SimLog interaction class.
     * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog', 'property_name': 'Comment'}");
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog', 'property_name': 'FedName'}");
                _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
                _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog', 'property_name': 'Time'}");
                _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
                _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
