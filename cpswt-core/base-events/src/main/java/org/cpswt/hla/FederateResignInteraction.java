...
/**
* Implements InteractionRoot.C2WInteractionRoot.FederateResignInteraction
*/
public class FederateResignInteraction extends C2WInteractionRoot {
    ...
    /**
    * Creates an instance of the FederateResignInteraction interaction class with default parameter values.
    */
    ...
    /**
    * Returns the handle (RTI assigned) of the FederateResignInteraction interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the FederateResignInteraction interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    * class name) of the FederateResignInteraction interaction class.
    *
    ...
    * FederateResignInteraction interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.FederateResignInteraction");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction", FederateResignInteraction.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.FederateResignInteraction");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.FederateResignInteraction");
        _classHandleSimpleNameMap.put(get_handle(), "FederateResignInteraction");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction.FederateId", _FederateId_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction.FederateType", _FederateType_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction.IsLateJoiner", _IsLateJoiner_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.FederateResignInteraction.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the FederateResignInteraction interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the FederateResignInteraction interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the FederateResignInteraction interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the FederateResignInteraction interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the FederateResignInteraction interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the FederateResignInteraction interaction class).
    ...
    * new FederateResignInteraction interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new FederateResignInteraction interaction class instance
    * @param logicalTime timestamp for this new FederateResignInteraction interaction class
    * instance
    */
    ...
    * of the instance referred to by FederateResignInteraction_var.
    *
    * @param FederateResignInteraction_var FederateResignInteraction interaction class instance of which
    * this newly created FederateResignInteraction interaction class instance will be a
    * duplicate
    */
    public FederateResignInteraction( FederateResignInteraction FederateResignInteraction_var ) {
        super( FederateResignInteraction_var );

        set_FederateId( FederateResignInteraction_var.get_FederateId() );
        set_FederateType( FederateResignInteraction_var.get_FederateType() );
        set_IsLateJoiner( FederateResignInteraction_var.get_IsLateJoiner() );
    }
