...
public class FederateJoinInteraction extends C2WInteractionRoot {
    ...
    private static final String OBJECT_CLASS_NAME = "InteractionRoot.C2WInteractionRoot.FederateJoinInteraction";
    private static final String OBJECT_SIMPLE_CLASS_NAME = "FederateJoinInteraction";
    private static final Logger logger = LogManager.getLogger(FederateJoinInteraction.class);
    ...
    static {
        ...
        _classNameClassMap.put(OBJECT_CLASS_NAME, FederateJoinInteraction.class);
    ...
    public FederateJoinInteraction(ReceivedInteraction datamemberMap, boolean initFlag) {
        super(datamemberMap, initFlag);
        if ( initFlag ) setParameters( datamemberMap );
    }

    public FederateJoinInteraction(ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag) {
    ...
    public FederateJoinInteraction(FederateJoinInteraction federateJoinInteraction) {
        super(federateJoinInteraction);

        setFederateId(federateJoinInteraction.getFederateId());
        setFederateType(federateJoinInteraction.getFederateType());
        setLateJoiner(federateJoinInteraction.isLateJoiner());
    }
