...
static {
    ...
    _classNameClassMap.put(get_class_name(), FederateResignInteraction.class);
...
protected static void init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            ...
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateResignInteraction', 'property_name': 'FederateId'}");
            ...
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateResignInteraction', 'property_name': 'FederateType'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
            ...
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateResignInteraction', 'property_name': 'IsLateJoiner'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
