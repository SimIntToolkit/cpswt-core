...
/**
* Implements InteractionRoot.C2WInteractionRoot.SimLog.HighPrio
*/
public class HighPrio extends SimLog {
    ...
    /**
    * Creates an instance of the HighPrio interaction class with default parameter values.
    */
    public HighPrio() {}
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the HighPrio interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    protected static void init(RTIambassador rti) {
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SimLog.HighPrio.Comment", _Comment_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SimLog.HighPrio.FedName", _FedName_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SimLog.HighPrio.Time", _Time_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SimLog.HighPrio.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SimLog.HighPrio.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SimLog.HighPrio.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SimLog.HighPrio.sourceFed", _sourceFed_handle);
