...
public class FederateJoinInteraction extends org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot {
    ...
    */
    ...
    /**
     * Returns the fully-qualified (dot-delimited) federation name of the InteractionRoot.C2WInteractionRoot.FederateJoinInteraction interaction class.
     * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    static {
        ...
        _classNameClassMap.put(get_hla_class_name(), FederateJoinInteraction.class);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'FederateId'}");
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'FederateType'}");
                _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
                _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
                ...
                classAndPropertyName = new ClassAndPropertyName(get_hla_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'IsLateJoiner'}");
                _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
                _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
