...
/**
 * Implements InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction
 */
...
/**
 * Returns the fully-qualified (dot-delimited) name of the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class.
...
public static String get_class_name() {
    return "InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction";
}
 ...
 * class name) of the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class.
 *
 ...
 * InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
...
static {
    ...
    _classNameClassMap.put(get_class_name(), FederateJoinInteraction.class);
    ...
    key = new ClassAndPropertyName(get_class_name(), "IsLateJoiner");
    _classAndPropertyNameTypeMap.put(key, "boolean");

    key = new ClassAndPropertyName(get_class_name(), "FederateId");
...
/**
 * Returns the handle (RTI assigned) of the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
 ...
 * this interaction class (i.e. "InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction") given the parameter's name.
 *
...
protected static void init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'FederateId'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'FederateId'}");
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'FederateType'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'FederateType'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'IsLateJoiner'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction', 'property_name': 'IsLateJoiner'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
...
/**
 * Publishes the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class for a federate.
 *
...
/**
 * Unpublishes the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class for a federate.
 *
...
/**
 * Subscribes a federate to the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class.
 *
 * @param rti handle to the Local RTI Component
 */
...
/**
 * Unsubscribes a federate from the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class.
 *
 * @param rti handle to the Local RTI Component
 */
 ...
 * (that is, the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class).
 *
 * @param handle handle to compare to the value of the handle (RTI assigned) of
 * this class (the InteractionRoot_p.C2WInteractionRoot_p.FederateJoinInteraction interaction class).
...
public void set_IsLateJoiner(Boolean value) {
    ClassAndPropertyName key = new ClassAndPropertyName(get_class_name(), "IsLateJoiner");
...
public void set_FederateId(String value) {
    ClassAndPropertyName key = new ClassAndPropertyName(get_class_name(), "FederateId");
    classAndPropertyNameValueMap.put(key, value);
}
