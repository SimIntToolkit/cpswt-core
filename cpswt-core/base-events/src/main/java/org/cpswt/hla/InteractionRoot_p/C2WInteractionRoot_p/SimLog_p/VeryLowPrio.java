...
static {
    ...
    _classNameClassMap.put(get_class_name(), VeryLowPrio.class);
...
protected static void init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'Comment'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'Comment'}");
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'FedName'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'FedName'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'Time'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'Time'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'originFed'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'originFed'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'sourceFed'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.VeryLowPrio', 'property_name': 'sourceFed'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
...
//------------------------------------
    ...
    * new VeryLowPrio parameter class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new VeryLowPrio interaction class instance
    * @param logicalTime timestamp for this new VeryLowPrio interaction class instance
    */
    ...
    *
    * @param messaging_var VeryLowPrio interaction class instance of which
