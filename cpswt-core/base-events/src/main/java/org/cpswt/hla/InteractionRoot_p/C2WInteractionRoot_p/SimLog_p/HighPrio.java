...
public class HighPrio extends org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot_p.SimLog {
    ...
    */
    ...
    /**
     * Returns the fully-qualified (dot-delimited) federation name of the InteractionRoot.C2WInteractionRoot.SimLog.HighPrio interaction class.
     * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    static {
        ...
        _classNameClassMap.put(get_hla_class_name(), HighPrio.class);
