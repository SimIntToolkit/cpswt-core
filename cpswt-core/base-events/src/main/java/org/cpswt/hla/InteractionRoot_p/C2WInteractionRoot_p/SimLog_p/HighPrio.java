...
/**
 * Implements InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio
 */
...
/**
 * Returns the fully-qualified (dot-delimited) name of the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class.
...
public static String get_class_name() {
    return "InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio";
}
 ...
 * class name) of the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class.
 *
 ...
 * InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
...
static {
    ...
    _classNameClassMap.put(get_class_name(), HighPrio.class);
...
/**
 * Returns the handle (RTI assigned) of the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
 ...
 * this interaction class (i.e. "InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio") given the parameter's name.
 *
...
protected static void init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'Comment'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'Comment'}");
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'FedName'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'FedName'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'Time'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'Time'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'originFed'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'originFed'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'sourceFed'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio', 'property_name': 'sourceFed'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
...
/**
 * Publishes the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class for a federate.
 *
...
/**
 * Unpublishes the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class for a federate.
 *
...
/**
 * Subscribes a federate to the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class.
 *
 * @param rti handle to the Local RTI Component
 */
...
/**
 * Unsubscribes a federate from the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class.
 *
 * @param rti handle to the Local RTI Component
 */
 ...
 * (that is, the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class).
 *
 * @param handle handle to compare to the value of the handle (RTI assigned) of
 * this class (the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.HighPrio interaction class).
...
//------------------------------------
    ...
    * new HighPrio parameter class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new HighPrio interaction class instance
    * @param logicalTime timestamp for this new HighPrio interaction class instance
    */
