...
public class SimEnd extends org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot_p.SimulationControl {
    ...
    */
    ...
    /**
     * Returns the fully-qualified (dot-delimited) federation name of the InteractionRoot.C2WInteractionRoot.SimulationControl.SimEnd interaction class.
     * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    public static String get_hla_class_name() {
        return "InteractionRoot.C2WInteractionRoot.SimulationControl.SimEnd";
    }
    ...
    static {
        ...
        _classNameClassMap.put(get_hla_class_name(), SimEnd.class);
