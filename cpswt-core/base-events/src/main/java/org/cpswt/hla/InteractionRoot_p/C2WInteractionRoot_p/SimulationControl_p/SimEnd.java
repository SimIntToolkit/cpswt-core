...
/**
 * Implements InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd
 */
@SuppressWarnings("unused")
public class SimEnd extends org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot_p.SimulationControl {
...
/**
 * Returns the fully-qualified (dot-delimited) name of the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class.
...
public static String get_class_name() {
    return "InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd";
}
 ...
 * class name) of the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class.
 *
 ...
 * InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
...
static {
    ...
    _classNameClassMap.put(get_class_name(), SimEnd.class);
...
/**
 * Returns the handle (RTI assigned) of the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
 ...
 * this interaction class (i.e. "InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd") given the parameter's name.
 *
...
protected static void init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd', 'property_name': 'originFed'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd', 'property_name': 'originFed'}");
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd', 'property_name': 'sourceFed'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd', 'property_name': 'sourceFed'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
...
/**
 * Publishes the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class for a federate.
 *
...
/**
 * Unpublishes the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class for a federate.
 *
...
/**
 * Subscribes a federate to the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class.
 *
 * @param rti handle to the Local RTI Component
 */
...
/**
 * Unsubscribes a federate from the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class.
 *
 * @param rti handle to the Local RTI Component
 */
 ...
 * (that is, the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class).
 *
 * @param handle handle to compare to the value of the handle (RTI assigned) of
 * this class (the InteractionRoot_p.C2WInteractionRoot_p.SimulationControl_p.SimEnd interaction class).
...
//------------------------------------
    ...
    protected SimEnd( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected SimEnd( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
    ...
    */
    public SimEnd( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #SimEnd( ReceivedInteraction datamemberMap )}, except this
    ...
    */
    public SimEnd( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new SimEnd interaction class instance that is a duplicate
    * of the instance referred to by messaging_var.
    *
    * @param messaging_var SimEnd interaction class instance of which
    * this newly created SimEnd interaction class instance will be a
    * duplicate
    */
