...
public class MediumPrio extends org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot_p.SimLog {
    ...
    */
    ...
    /**
     * Returns the fully-qualified (dot-delimited) federation name of the InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio interaction class.
     * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    public static String get_hla_class_name() {
        return "InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio";
    }
