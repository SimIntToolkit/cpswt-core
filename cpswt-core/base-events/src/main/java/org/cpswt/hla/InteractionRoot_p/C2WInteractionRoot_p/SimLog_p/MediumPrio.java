...
/**
 * Implements InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio
 */
@SuppressWarnings("unused")
public class MediumPrio extends org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot_p.SimLog {
...
/**
 * Returns the fully-qualified (dot-delimited) name of the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class.
...
public static String get_class_name() {
    return "InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio";
}
 ...
 * class name) of the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class.
 *
 ...
 * InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
...
static {
    ...
    _classNameClassMap.put(get_class_name(), MediumPrio.class);
    ...
    key = new ClassAndPropertyName(get_class_name(), "FedName");
    _classAndPropertyNameTypeMap.put(key, "String");

    key = new ClassAndPropertyName(get_class_name(), "originFed");
    _classAndPropertyNameTypeMap.put(key, "String");

    key = new ClassAndPropertyName(get_class_name(), "Comment");
    _classAndPropertyNameTypeMap.put(key, "String");

    key = new ClassAndPropertyName(get_class_name(), "Time");
...
/**
 * Returns the handle (RTI assigned) of the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class.
 * Note: As this is a static method, it is NOT polymorphic, and so, if called on
...
protected static int get_parameter_handle_aux(String className, String propertyName) {
    ...
    return org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot_p.SimLog.get_parameter_handle_aux(className, propertyName);    
}

/**
 * Returns the handle of an parameter (RTI assigned) of
 * this interaction class (i.e. "InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio") given the parameter's name.
 *
...
protected static void init(RTIambassador rti) {
    ...
    _isInitialized = true;
    org.cpswt.hla.InteractionRoot_p.C2WInteractionRoot_p.SimLog.init(rti);
    ...
    while(isNotInitialized) {
        try {
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'Comment'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'Comment'}");
            ...
            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'FedName'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'FedName'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'Time'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'Time'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'originFed'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'originFed'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);

            propertyHandle = rti.getParameterHandle("{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'sourceFed'}", get_class_handle());
            classAndPropertyName = new ClassAndPropertyName(get_class_name(), "{'class_name': 'InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio', 'property_name': 'sourceFed'}");
            _classAndPropertyNameHandleMap.put(classAndPropertyName, propertyHandle);
            _handleClassAndPropertyNameMap.put(propertyHandle, classAndPropertyName);
...
/**
 * Publishes the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class for a federate.
 *
...
/**
 * Unpublishes the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class for a federate.
 *
...
/**
 * Subscribes a federate to the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class.
 *
 * @param rti handle to the Local RTI Component
 */
...
/**
 * Unsubscribes a federate from the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class.
 *
 * @param rti handle to the Local RTI Component
 */
 ...
 * (that is, the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class).
 *
 * @param handle handle to compare to the value of the handle (RTI assigned) of
 * this class (the InteractionRoot_p.C2WInteractionRoot_p.SimLog_p.MediumPrio interaction class).
...
public void set_FedName(String value) {
    ClassAndPropertyName key = new ClassAndPropertyName(get_class_name(), "FedName");
...
public void set_Comment(String value) {
    ClassAndPropertyName key = new ClassAndPropertyName(get_class_name(), "Comment");
    classAndPropertyNameValueMap.put(key, value);
}
...
public void set_Time(Double value) {
    ClassAndPropertyName key = new ClassAndPropertyName(get_class_name(), "Time");
    classAndPropertyNameValueMap.put(key, value);
}
...
//------------------------------------
    ...
    *
    * @param messaging_var MediumPrio interaction class instance of which
