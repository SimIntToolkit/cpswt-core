...
/**
* The SimPause class implements the SimPause interaction in the
* c2w.hla simulation.
*/
public class SimPause extends SimulationControl {

	/**
	* Default constructor -- creates an instance of the SimPause interaction
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the SimPause interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the SimPause
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the SimPause interaction class.
	*/
	public static String get_simple_class_name() { return "SimPause"; }
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause", SimPause.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause" );
		_classHandleSimpleNameMap.put( get_handle(), "SimPause" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause,sourceFed", get_sourceFed_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause,originFed", get_originFed_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause,actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause,federateFilter", get_federateFilter_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause:  could not publish:  ";

	/**
	* Publishes the SimPause interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause:  could not unpublish:  ";
	/**
	* Unpublishes the SimPause interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause:  could not subscribe:  ";
	/**
	* Subscribes a federate to the SimPause interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.SimulationControl.SimPause:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the SimPause interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the SimPause interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the SimPause interaction class).
	...
	* new SimPause interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new SimPause interaction class instance
	* @param logicalTime timestamp for this new SimPause interaction class
	* instance
	*/
	...
	* of the instance referred to by SimPause_var.
	*
	* @param SimPause_var SimPause interaction class instance of which
	* this newly created SimPause interaction class instance will be a
	* duplicate
	*/
	public SimPause( SimPause SimPause_var ) {
		super( SimPause_var );
		
		
		set_sourceFed( SimPause_var.get_sourceFed() );
		set_originFed( SimPause_var.get_originFed() );
		set_actualLogicalGenerationTime( SimPause_var.get_actualLogicalGenerationTime() );
		set_federateFilter( SimPause_var.get_federateFilter() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof SimPause ) {
			SimPause data = (SimPause)object;
