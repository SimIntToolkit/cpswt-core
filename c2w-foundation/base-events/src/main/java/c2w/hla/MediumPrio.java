...
public class MediumPrio extends SimLog {
	...
	*/
	...
	protected static void init( RTIambassador rti ) {
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio,Time", get_Time_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio,sourceFed", get_sourceFed_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio,FedName", get_FedName_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio,originFed", get_originFed_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio,Comment", get_Comment_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio,actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.MediumPrio,federateFilter", get_federateFilter_handle() );
	...
	*/
	public MediumPrio( MediumPrio MediumPrio_var ) {
		...
		set_Time( MediumPrio_var.get_Time() );
		set_sourceFed( MediumPrio_var.get_sourceFed() );
		set_FedName( MediumPrio_var.get_FedName() );
		set_originFed( MediumPrio_var.get_originFed() );
		set_Comment( MediumPrio_var.get_Comment() );
		set_actualLogicalGenerationTime( MediumPrio_var.get_actualLogicalGenerationTime() );
		set_federateFilter( MediumPrio_var.get_federateFilter() );
	}
