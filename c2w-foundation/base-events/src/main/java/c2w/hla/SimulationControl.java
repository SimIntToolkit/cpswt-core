...
public class SimulationControl extends C2WInteractionRoot {
	...
	*/
	...
	protected static void init( RTIambassador rti ) {
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl,actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimulationControl,federateFilter", get_federateFilter_handle() );
	...
	*/
	public SimulationControl( SimulationControl SimulationControl_var ) {
		...
		set_actualLogicalGenerationTime( SimulationControl_var.get_actualLogicalGenerationTime() );
		set_federateFilter( SimulationControl_var.get_federateFilter() );
	}
