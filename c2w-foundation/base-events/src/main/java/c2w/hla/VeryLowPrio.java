...
public class VeryLowPrio extends SimLog {
	...
	*/
	...
	protected static void init( RTIambassador rti ) {
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.VeryLowPrio,Time", get_Time_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.VeryLowPrio,sourceFed", get_sourceFed_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.VeryLowPrio,FedName", get_FedName_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.VeryLowPrio,originFed", get_originFed_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.VeryLowPrio,Comment", get_Comment_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.VeryLowPrio,actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.SimLog.VeryLowPrio,federateFilter", get_federateFilter_handle() );
	...
	*/
	public VeryLowPrio( VeryLowPrio VeryLowPrio_var ) {
		...
		set_Time( VeryLowPrio_var.get_Time() );
		set_sourceFed( VeryLowPrio_var.get_sourceFed() );
		set_FedName( VeryLowPrio_var.get_FedName() );
		set_originFed( VeryLowPrio_var.get_originFed() );
		set_Comment( VeryLowPrio_var.get_Comment() );
		set_actualLogicalGenerationTime( VeryLowPrio_var.get_actualLogicalGenerationTime() );
		set_federateFilter( VeryLowPrio_var.get_federateFilter() );
	}
