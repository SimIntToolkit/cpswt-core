 ...
 * HelloWorld_Java_Tutorial simulation.
 */
public class PingCount extends ObjectRoot {
     ...
     */
    public static int get_RunningCount_handle() {
        return _RunningCount_handle;
    }
     ...
     */
    public static int get_SinkName_handle() {
        return _SinkName_handle;
    }
    ...
    protected SuppliedAttributes createSuppliedDatamembers(boolean force) {
        ...
        try {
            ...
            System.err.println("ERROR:  ObjectRoot.PingCount.createSuppliedAttributes:  could not determine if RunningCount is published.");
            isPublished = false;
        }
        ...
        try {
            ...
            System.err.println("ERROR:  ObjectRoot.PingCount.createSuppliedAttributes:  could not determine if SinkName is published.");
            isPublished = false;
        }
