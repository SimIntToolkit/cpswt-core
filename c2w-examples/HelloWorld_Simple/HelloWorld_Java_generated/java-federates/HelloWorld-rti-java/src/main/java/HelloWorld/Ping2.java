...
/**
* The Ping2 class implements the Ping2 interaction in the
* HelloWorld simulation.
*/
public class Ping2 extends C2WInteractionRoot {

	/**
	* Default constructor -- creates an instance of the Ping2 interaction
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the Ping2 interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the Ping2
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.Ping2"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the Ping2 interaction class.
	*/
	public static String get_simple_class_name() { return "Ping2"; }
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.Ping2" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.Ping2", Ping2.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.Ping2", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.Ping2", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Ping2:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.Ping2" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.Ping2", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.Ping2" );
		_classHandleSimpleNameMap.put( get_handle(), "Ping2" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.Ping2,Count", get_Count_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Ping2:  could not publish:  ";

	/**
	* Publishes the Ping2 interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Ping2:  could not unpublish:  ";
	/**
	* Unpublishes the Ping2 interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Ping2:  could not subscribe:  ";
	/**
	* Subscribes a federate to the Ping2 interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Ping2:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the Ping2 interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the Ping2 interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the Ping2 interaction class).
	...
	*/
	...
	protected Ping2( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected Ping2( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the Ping2 interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new Ping2 interaction class instance
	*/
	public Ping2( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #Ping2( ReceivedInteraction datamemberMap )}, except this
	* new Ping2 interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new Ping2 interaction class instance
	* @param logicalTime timestamp for this new Ping2 interaction class
	* instance
	*/
	public Ping2( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new Ping2 interaction class instance that is a duplicate
	* of the instance referred to by Ping2_var.
	*
	* @param Ping2_var Ping2 interaction class instance of which
	* this newly created Ping2 interaction class instance will be a
	* duplicate
	*/
	public Ping2( Ping2 Ping2_var ) {
		super( Ping2_var );
		
		
		set_Count( Ping2_var.get_Count() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof Ping2 ) {
			Ping2 data = (Ping2)object;
