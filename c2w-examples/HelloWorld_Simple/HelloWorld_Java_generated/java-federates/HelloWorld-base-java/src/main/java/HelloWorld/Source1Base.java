...
public class Source1Base extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public Source1Base( String federation_id, String federate_id ) throws Exception {
       ...
       // constructor
	public Source1Base(  String[] federationInfo ) throws Exception {
	...
	public Ping1 create_Ping1() {
	   Ping1 interaction = new Ping1();
