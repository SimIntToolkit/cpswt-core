...
public class Source3Base extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public Source3Base( String federation_id, String federate_id ) throws Exception {
        ...
        Ping3.publish( getRTI() );
        		
		// object pubsub
                        }
        
       // constructor
	public Source3Base(  String[] federationInfo ) throws Exception {
	...
	public Ping3 create_Ping3() {
	   Ping3 interaction = new Ping3();
