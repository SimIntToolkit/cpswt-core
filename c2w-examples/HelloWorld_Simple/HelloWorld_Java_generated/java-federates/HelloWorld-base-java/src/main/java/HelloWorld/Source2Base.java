...
public class Source2Base extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public Source2Base( String federation_id, String federate_id ) throws Exception {
        ...
        Ping2.publish( getRTI() );
        		
		// object pubsub
                        }
        
       // constructor
	public Source2Base(  String[] federationInfo ) throws Exception {
	...
	public Ping2 create_Ping2() {
	   Ping2 interaction = new Ping2();
