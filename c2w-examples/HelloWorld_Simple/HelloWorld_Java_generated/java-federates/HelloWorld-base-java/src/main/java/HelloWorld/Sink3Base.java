...
public class Sink3Base extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public Sink3Base( String federation_id, String federate_id ) throws Exception {
        ...
        Ping2.subscribe( getRTI() );
        _subscribedInteractionFilter.setFedFilters( 
			Ping2.get_handle(), 
			SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED, 
			SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED 
		);
        Ping3.subscribe( getRTI() );
        _subscribedInteractionFilter.setFedFilters( 
			Ping3.get_handle(), 
			SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED, 
			SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED 
       ...
       // constructor
	public Sink3Base(  String[] federationInfo ) throws Exception {
		...
		if(federationInfo.length  > 2) {
			...
			Ping2.enableSubscribeLog(
				"Ping2",
				"Sink3", 
				"NORMAL", 
				loglevel);
			Ping3.enableSubscribeLog(
				"Ping3",
				"Sink3", 
				"NORMAL", 
				loglevel);
			Ping1.enableSubscribeLog(
				"Ping1",
				"Sink3", 
				"NORMAL", 
				loglevel);	
